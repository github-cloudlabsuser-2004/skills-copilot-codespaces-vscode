...
9. In the **Security** tab, configure the following settings:
    - **DDoS protection**: Enable or disable DDoS protection for the virtual network.
    - **Firewall**: Configure network security groups and firewall rules.
